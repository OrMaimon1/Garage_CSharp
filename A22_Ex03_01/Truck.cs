...
namespace A22_Ex03_01
{
    public class Truck : Vehicle
    {
        ...
        private const string k_DoesHaveCargoMessage = "Does the truck has cargo(Yes /No): ";
        ...
        public override void UpdateInfo(string i_KeyMessage, string i_UserInput)
        {
            switch (i_KeyMessage)
            {
        ...
        public static void CargoCapacityValidating(string i_UserInput)
        {
...
Has Cargo: {0}
Cargo Capacity: {1}"+Environment.NewLine , HasCargo , CargoCapacity);
            return details;
        }
    }
}
